...
namespace HeathenEngineering.SteamworksIntegration
{
    ...
    public struct LeaderboardData : IEquatable<SteamLeaderboard_t>, IEquatable<ulong>, IEquatable<string>
    {
        ...
        public void ForceUploadScore(int score, int[] details) => UploadScore(score, details, ELeaderboardUploadScoreMethod.k_ELeaderboardUploadScoreMethodForceUpdate);
        ...
        public void KeepBestUploadScore(int score, int[] details) => UploadScore(score, details, ELeaderboardUploadScoreMethod.k_ELeaderboardUploadScoreMethodKeepBest);
